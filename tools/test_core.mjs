...
import {toOrdinal,fromOrdinal,formatYear,shiftYear,active,distance,fromParts,parts} from '../js/core.js';
...
eq(shiftYear(-1,1,-12000,2026),1);eq(shiftYear(1,-1,-12000,2026),-1);eq(shiftYear(-5,10,-12000,2026),6);
