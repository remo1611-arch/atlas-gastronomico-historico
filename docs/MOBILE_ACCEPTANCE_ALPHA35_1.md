# Aceptación móvil · alpha.35.1 · G4 Pilot A

## Identidad
- [ ] La interfaz muestra `alpha.35.1`.
...
## Criterio de PASS
El visitante debe comprender que **un vector histórico puede estar documentado aunque no pueda dibujarse responsablemente como ruta**. Si el panel induce a pensar que “falta cargar el mapa”, alpha.35.1 necesita ajuste UX antes de Pilot B.


## Limpieza pública específica alpha.35.1

- [ ] La cabecera muestra **Museo digital** sin número de alpha permanente.
- [ ] En Capas aparece **Vínculos documentados**, sin `G4`, `PILOTO` ni códigos de fase.
- [ ] El panel de vínculos usa la etiqueta pública **CONEXIONES**.
- [ ] «Acerca del atlas» explica los vínculos sin mencionar G4/piloto.
- [ ] «Acerca del atlas» muestra la versión `0.1.0-alpha.35.1` como dato diagnóstico discreto.
